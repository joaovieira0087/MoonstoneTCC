...
{
    /// <inheritdoc />
    public partial class AddPerguntaUsuario : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PerguntasUsuarios",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerguntasUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerguntasUsuarios_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerguntasUsuarios_UsuarioId",
